  ...
  private  DefaultTableModel modelo;
   private AlquilerData alqd;
    ...
    public BuscarAlquileres() {
      ...
      JOptionPane.showMessageDialog(null, "Debes ingresar una dirección para buscar");
        } else {
            modelo = (DefaultTableModel) this.tablaAlquileres.getModel();
            ...
            for (int i = 0; i < alquils.size(); i++) {
                ...
                JOptionPane.showMessageDialog(null, "No existen alquileres registrados con esa dirección");
            }
    }
